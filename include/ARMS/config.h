...
#define LEFT_MOTORS 12, 14
#define RIGHT_MOTORS 11, 13
...
#define TRACK_WIDTH                                                            \
	15 // The distance between left and right wheels (or tracker wheels)
...
#define AUTONS "Left", "Right", "None" // Names of autonomi, up to 10
#define HUE 359     // Color of theme from 0-359(H part of HSV)
